...
- Use a `scratchpad.md` file in the `.fact` directory to plan your work. If it does not exist, create it.
- **Clear or overwrite** previous contents of `.fact/scratchpad.md` at the start of a new task so you have a clean workspace.
...
- Always read `.fact/knowledge.md`. If it does not exist, create it.
...
Once a task is completed and verified to work correctly, you must transfer any new, generalized, or project-specific working knowledge into `.fact/knowledge.md`.
